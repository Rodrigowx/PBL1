...
public class DadosPreCadastro {
	...
	public static void LeituraArquivos(SelecaoDAOImpl SelecaoDAO, JogadorDAOImpl JogadorDAO, FaseGrupos GruposCRUD) {
		...
		try {
			String arquivoPath = new File("PBL1/src/app/DadosArquivo/arquivoDeDados.txt").getAbsolutePath();
		...
		//Leitura Jogadores
		try {
			String arquivoJogPath = new File("PBL1/src/app/DadosArquivo/dadosJogadores.txt").getAbsolutePath();
	...
	public static void LeituraTecnicoArbitro(SelecaoDAOImpl SelecaoDAO, TecnicoDAOImpl TecnicoDAO, ArbitroDAOImpl ArbitroDAO, FaseGrupos GruposCRUD) {
		//LENDO TÉCNICOS
		try {
			String arquivoPath = new File("PBL1/src/app/DadosArquivo/dadosTecnicos.txt").getAbsolutePath();
		...
		//LENDO ÁRBITROS
		try {
			String arquivoPath = new File("PBL1/src/app/DadosArquivo/dadosArbitros.txt").getAbsolutePath();
